...
struct TestLinalgFusionTransforms
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLinalgFusionTransforms)
...
struct TestLinalgFusionTransformsLoops
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLinalgFusionTransformsLoops)
...
struct TestLinalgFusionTransformsTiledLoops
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLinalgFusionTransformsTiledLoops)
...
struct TestLinalgGreedyFusion
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLinalgGreedyFusion)
...
struct TestLinalgTileAndFuseSequencePass
    : public PassWrapper<TestLinalgTileAndFuseSequencePass,
                         OperationPass<FuncOp>> {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLinalgTileAndFuseSequencePass)
