...
struct TestSCFForUtilsPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestSCFForUtilsPass)
...
struct TestSCFIfUtilsPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestSCFIfUtilsPass)
...
struct TestSCFPipeliningPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestSCFPipeliningPass)
