...
struct TestFuncInsertArg
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFuncInsertArg)
...
struct TestFuncInsertResult
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFuncInsertResult)
...
struct TestFuncEraseArg
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFuncEraseArg)
...
struct TestFuncEraseResult
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFuncEraseResult)
...
struct TestFuncSetType
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFuncSetType)
