...
struct TestModulePass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestModulePass)
...
struct TestFunctionPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFunctionPass)
...
struct TestInterfacePass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestInterfacePass)
...
struct TestOptionsPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestOptionsPass)
...
struct TestCrashRecoveryPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestCrashRecoveryPass)
...
struct TestFailurePass : public PassWrapper<TestFailurePass, OperationPass<>> {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFailurePass)
...
struct TestInvalidParentPass
    : public PassWrapper<TestInvalidParentPass,
                         InterfacePass<FunctionOpInterface>> {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestInvalidParentPass)
...
struct TestStatisticPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestStatisticPass)
