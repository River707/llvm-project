...
struct GenericAnalysis {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(GenericAnalysis)
...
struct AnnotateFunctionPass
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(AnnotateFunctionPass)
...
struct InvalidPass : Pass {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(InvalidPass)
