...
struct AnotherTestDialect : public Dialect {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(AnotherTestDialect)
...
struct SecondTestDialect : public Dialect {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SecondTestDialect)
...
struct TestDialectInterfaceBase
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestDialectInterfaceBase)
...
struct TestDialectInterface : public TestDialectInterfaceBase {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestDialectInterface)
...
struct SecondTestDialectInterface : public TestDialectInterfaceBase {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SecondTestDialectInterface)
