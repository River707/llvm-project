...
struct CustomDataLayoutSpec
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(CustomDataLayoutSpec)
...
struct SingleQueryType
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SingleQueryType)
...
struct TypeNoLayout : public Type::TypeBase<TypeNoLayout, Type, TypeStorage> {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TypeNoLayout)
...
struct OpWithLayout : public Op<OpWithLayout, DataLayoutOpInterface::Trait> {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(OpWithLayout)
...
struct OpWith7BitByte
  ...
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(OpWith7BitByte)
...
struct DLTestDialect : Dialect {
  DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(DLTestDialect)
